"""
Script to test the performance of different coding LLMs

Loops through a list of generative coding LLMs and evaluates their
performance on generating SPARQL queries from natural language questions.
"""
...
print("Testing coding-focused LLMs...")
for llm in CODE_LLMS:
    ...
    for question, response, duration in responses:
        ...
        code_llm_responses.append((llm, question, response, duration))

print("Done with testing code-focused LLMs.")

code_df = pd.DataFrame(
    code_llm_responses, columns=["LLM", "Question", "Response", "Duration"]
)
code_df.to_csv("code_llm_responses.csv", index=False)

print(f"Wrote results to CSV code_llm_responses.csv")
